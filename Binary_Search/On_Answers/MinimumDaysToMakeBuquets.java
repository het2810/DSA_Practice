...
public class MinimumDaysToMakeBuquets {
	...
	public static void main(String[] args) {
		...
		int n = nums.length; // lenght of array
		int m = 2; // No of buquets
		int k = 3; // No of Flowers requires to create 1 buquet
		MinimumDaysToMakeBuquets mg = new MinimumDaysToMakeBuquets();
		System.out.println(mg.roseGarden(n, nums, k, m));
	}
}
